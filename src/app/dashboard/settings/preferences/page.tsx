                ...
                {preferenceOptions.map((option) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center justify-between gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-left transition hover:border-blue-200 hover:bg-white"
                    >
