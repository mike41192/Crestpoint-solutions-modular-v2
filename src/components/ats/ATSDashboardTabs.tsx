...
// =====================================================
// BLOCK: ATS Tab Config
// =====================================================

const tabs = [
  { id: "overview", label: "Overview", icon: BarChart3 },
  { id: "keywords", label: "Keywords", icon: SearchCheck },
  { id: "gaps", label: "Gap Analysis", icon: ListChecks },
  { id: "risks", label: "Risk Flags", icon: AlertTriangle },
  { id: "recommendations", label: "Recommendations", icon: Sparkles },
  { id: "apply", label: "Apply Fixes", icon: CheckCircle2 },
] as const
...
export function ATSDashboardTabs({
  ...
  return (
    <div className="overflow-x-auto rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
      <div className="grid min-w-max grid-cols-6 gap-3 xl:min-w-0">
        {tabs.map((tab) => {
          const Icon = tab.icon
